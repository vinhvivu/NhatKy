...
class Post extends Component {
  ...
  submit = () =>{
    ...
    <View style={styles.container}>
        ...
        <TextInput style={{marginTop:20, height:90, borderColor:'gray', borderWidth:1}} placeholder="Nội dung" onChangeText={content => this.setState({content})} value={this.state.content} />
     <Button title="Ghi chú" onPress={this.submit} />
